...
-- Q.2 Write a query to retrieve all transactions where the category is 'clothing ' and quantity sold is more than 10 in the month of NOV-2022
...
-- Q.4 Write a query to find the average age of customers who purchased items from the average 'Beauty' Category
